...
try:
    ...
    def TestCase():
      ...
      try: 
          ...
          msg += "\nTesting bh.bf_order()..."
          expected_trav = expected_heap.bf_order()
          student_trav = student_heap.bf_order()
          
          msg += "\n\nExpected bf-traversal:\n" + str(expected_trav) 
          msg += "\nReturned bf-traversal:\n" + str(student_trav) 
...
f = open("/outputs/101789.json", "w")
json.dump({"id": "101789", "passed": output.passed, "log": output.logs}, f)
f.close()
