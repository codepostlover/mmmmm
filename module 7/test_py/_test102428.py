...
try:
    ...
    def TestCase():
      ...
      elements = sorted([random.randint(-30, 30) for i in range(random.randint(10, 15))])
...
f = open("/outputs/102428.json", "w")
json.dump({"id": "102428", "passed": output.passed, "log": output.logs}, f)
f.close()
