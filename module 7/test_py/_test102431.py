...
try:
    ...
    def TestCase():
      ...
      msg = f"Using QUICK SORT FIRST ELEMENT PIVOT to sort array: {str(elements)}"
      algorithms.quick_sort(array, False)
...
f = open("/outputs/102431.json", "w")
json.dump({"id": "102431", "passed": output.passed, "log": output.logs}, f)
f.close()
