...
try:
    ...
    def TestCase():
      ...
      msg = f"Using QUICK SORT RANDOM ELEMENT PIVOT to sort array: {str(elements)}"
      algorithms.quick_sort(array, True)
...
f = open("/outputs/102434.json", "w")
json.dump({"id": "102434", "passed": output.passed, "log": output.logs}, f)
f.close()
