...
try:
    ...
    def TestCase():
      ...
      try:
        ...
        test1 = comparators.list_equals(graph, student_graph)
        ...
        msg += "\n\nExpected graph after removal:\n" + expected_graph2
        msg += "\n\nStudent graph after removal:\n" + returned_graph2
        test2 = comparators.list_equals(graph, student_graph)
...
f = open("/outputs/103332.json", "w")
json.dump({"id": "103332", "passed": output.passed, "log": output.logs}, f)
f.close()
